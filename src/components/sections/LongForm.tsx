...
import { videos as VIDEOS, Video } from "@/lib/videos";
            ...
            >
                {VIDEOS.map((video) => (
                    ...
                    >
                        {video.path ? (
                            <video
                                ...
                                className={`absolute inset-0 w-full h-full object-cover transition-all duration-[600ms] ease-out ${isPremium
                                    ...
                                    : `filter ${isScrollingVideos ? 'grayscale-0 brightness-105 contrast-100 scale-105 saturate-110' : 'grayscale brightness-30 contrast-[1.3] scale-100 group-hover:grayscale-0 group-hover:brightness-105 group-hover:contrast-100 group-hover:scale-105 group-hover:saturate-110'}`
                                    }`}
                                playsInline
                                muted
                                preload="metadata"
                        ...
                        <div className={`absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent flex flex-col justify-end p-6 md:p-12 transition-all duration-700 ${!isPremium && !isScrollingVideos ? 'opacity-0 group-hover:opacity-100' : 'opacity-100'}`}>
